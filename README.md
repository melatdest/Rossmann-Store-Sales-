# Rossmann-Store-Sales-# Data Science in Production: A Sales Forecast Project Using Machine Learning for Rossmann
...
- **API tester: create a script to test the API**
  - Steps in Jupyter notebook:
    ...
    The `http://0.0.0.0:5000/rossmann/predict` part means that the API call is made to the local host `0.0.0.0` at the `5000` flask port at route name `rossmann/predict`. If it returns the code 200, it means that our API call succeded.
    &nbsp;  
