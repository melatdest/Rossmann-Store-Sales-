...
class Rossmann(object):
    def __init__(self):
        self.promo2_time_week_rs = pickle.load(open('/home/alan/Sales-Prediction/parameter/promo_time_week_rs.pkl', 'rb'))
        self.promo2_time_month_rs = pickle.load(open('/home/alan/Sales-Prediction/parameter/promo_time_month_rs.pkl', 'rb'))
        self.competition_distance_yeojohn = pickle.load( open('/home/alan/Sales-Prediction/parameter/competition_distance_yeojohn.pkl', 'rb'))
        self.customers_yeojohn = pickle.load(open('/home/alan/Sales-Prediction/parameter/customers_yeojohn.pkl', 'rb'))
        self.competition_since_month_yeojohn = pickle.load( open('/home/alan/Sales-Prediction/parameter/competition_since_month_yeojohn.pkl', 'rb'))
        self.year_mms = pickle.load( open('/home/alan/Sales-Prediction/parameter/year_mms.pkl', 'rb'))
        self.store_type_le = pickle.load( open('/home/alan/Sales-Prediction/parameter/store_type_le.pkl', 'rb'))
        self.competition_open_since_year_le = pickle.load(open('/home/alan/Sales-Prediction/parameter/competition_open_since_year_le.pkl', 'rb'))
